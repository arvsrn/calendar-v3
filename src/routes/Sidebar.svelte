...
<div class:translucent={$app.creatingNewEvent} class="transition-opacity duration-300 ease-ease w-[328px] h-full border-r border-gray3 flex flex-col flex-none">
